...
# To work your phone/PC from whom you'd like to initiate the sleep function has to be in the same network.
...
#when a connection is established the code would execute resulting in the PC going to sleep.

#This code listens to all IPs so it is enough to type localhost:4444 to start the code.
